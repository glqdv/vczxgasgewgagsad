...
!function(t, e) {
    ...
    var _t = document.documentElement.style
      ...
      , Ft = !!Ht && ((Ft = document.createElement("div")).innerHTML = "<svg/>",
    ...
    var b = {
      ...
      , Xt = !1;
    function Jt(t, e, i) {
        return "touchstart" !== e || Xt || (document.addEventListener(Wt, $t, !0),
    ...
    var mt = {
      ...
      , A = it.extend({
        ...
        panBy: function(t, e) {
            var i;
            return e = e || {},
            (t = m(t).round()).x || t.y ? (!0 === e.animate || this.getSize().contains(t) ? (this._panAnim || (this._panAnim = new We,
            this._panAnim.on({
    ...
    A.addInitHook(function() {
        this.options.zoomControl && (this.zoomControl = new Ge,
    ...
    ,
    {
        ...
        enable: function() {
            this._enabled || (S(this._dragStartTarget, Xe, this._onDown, this),
            this._enabled = !0)
        },
        disable: function() {
        ...
        _onDown: function(t) {
            ...
            ve(this._element, "leaflet-zoom-anim") || (t.touches && 1 !== t.touches.length ? Je._dragging === this && this.finishDrag() : Je._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((Je._dragging = this)._preventOutline && Me(this._element),
            Le(),
            re(),
    ...
    function ri(t, e, i) {
        ...
        for (s = 0; s < 4; s++) {
            ...
            o = (d = t.length) - 1; c < d; o = c++)
                r = t[c],
                a = t[o],
                r._code & h ? a._code & h || ((l = ei(a, r, h, e, i))._code = ii(l, e),
                n.push(l)) : (a._code & h && ((l = ei(a, r, h, e, i))._code = ii(l, e),
                n.push(l)),
                n.push(r));
            t = n
        }
    ...
    var xi = ui.extend({
        ...
        addData: function(t) {
            ...
            return (!r.filter || r.filter(t)) && (s = wi(t, r)) ? (s.feature = Ci(t),
    ...
    li.include({
        ...
        toGeoJSON: function(e) {
            ...
            this.eachLayer(function(t) {
                ...
                i ? n.push(t.geometry) : "FeatureCollection" === (t = Ci(t)).type ? n.push.apply(n, t.features) : n.push(t))
            }),
            i ? zi(this, {
                geometries: n,
    ...
    o.include({
        ...
        openPopup: function(t) {
            return this._popup && (this instanceof ui || (this._popup._source = this),
        ...
        _openPopup: function(t) {
            ...
            e = t.layer || t.target,
            this._popup._source !== e || e instanceof mi ? (this._popup._source = e,
    ...
    o.include({
        ...
        openTooltip: function(t) {
            return this._tooltip && (this instanceof ui || (this._tooltip._source = this),
    ...
    var Ui = function() {
      ...
      , zt = {
        ...
        _updateStyle: function(t) {
            ...
            o.stroked = !!n.stroke,
            o.filled = !!n.fill,
            n.stroke ? (e = e || (t._stroke = Ui("stroke")),
            o.appendChild(e),
    ...
    n.extend({
      ...
      , Yi = (A.addInitHook("addHandler", "touchZoom", Ot),
    A.BoxZoom = _t,
